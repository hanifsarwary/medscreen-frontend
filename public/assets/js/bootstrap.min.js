			...
			(e && 3 === e.which) ||
				...
				t(n).each(function () {
					...
					s.hasClass('open') &&
						...
						e.isDefaultPrevented() ||
							(o.attr('aria-expanded', 'false'), s.removeClass('open').trigger('hidden.bs.dropdown', n)));
				}));
		}
		function i(e) {
			...
			(i.prototype.backdrop = function (e) {
				...
				if (this.isShown && this.options.backdrop) {
					...
					if (
						...
						return;
					n
						? this.$backdrop.one('bsTransitionEnd', e).emulateTransitionEnd(i.BACKDROP_TRANSITION_DURATION)
						: e();
			...
			(i.prototype.show = function () {
				...
				if (this.hasContent() && this.enabled) {
					...
					t.support.transition && this.$tip.hasClass('fade')
						? n.one('bsTransitionEnd', m).emulateTransitionEnd(i.TRANSITION_DURATION)
						: m();
				}
			}),
			...
			(i.prototype.hide = function (e) {
				...
				return (
					...
					a.isDefaultPrevented()
						...
						: (n.removeClass('in'),
						  t.support.transition && this.$tip.hasClass('fade')
								? n.one('bsTransitionEnd', o).emulateTransitionEnd(i.TRANSITION_DURATION)
								: o(),
