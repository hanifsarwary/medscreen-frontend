...
!(function (e, t) {
	...
	e.fn.extend({
		...
		revscroll: function (i) {
			return this.each(function () {
				...
				a != t &&
					...
					e('body,html').animate({ scrollTop: a.offset().top + a.height() - i + 'px' }, { duration: 400 });
			});
		},
		...
		revkill: function (a) {
			...
			if (
				...
				o != t && o.length > 0 && e('body').find('#' + o.attr('id')).length > 0)
			) {
		...
		slotSize: function (i, a) {
			(a.slotw = Math.ceil(a.width / a.slots)),
				'fullscreen' == a.sliderLayout
					? (a.sloth = Math.ceil(e(window).height() / a.slots))
					: (a.sloth = Math.ceil(a.height / a.slots)),
	...
	var a = i.is_mobile(),
				...
				: (e.ajax({
						...
						error: function (e) {
							console.warn('Slider Revolution 5.0 Error !'),
								console.error(
									'Failure at Loading:' + i + a.extensions_suffix + ' on Path:' + a.jsFileLocation
								),
								console.info(e);
						},
				  }),
			...
			return (
				...
				o.data('version') && o.data('version').toString().match(/5./gi)
					? (o.find('img').each(function () {
					  ...
					  o.find('.tp-caption, .tp-static-layer, .rs-background-video-layer').each(function () {
							...
							(i.data('ytid') != t ||
								(i.find('iframe').length > 0 &&
									i.find('iframe').attr('src').toLowerCase().indexOf('youtube') > 0)) &&
								(r.videos = !0),
								(i.data('vimeoid') != t ||
									(i.find('iframe').length > 0 &&
										i.find('iframe').attr('src').toLowerCase().indexOf('vimeo') > 0)) &&
									(r.videos = !0),
					  ...
					  ('off' !== a.parallax.type || a.viewPort.enable || 'true' == a.viewPort.enable) &&
							(r.parallax = !0))
					: ((r.kenburns = !0),
					  (r.parallax = !0),
					  (r.carousel = !1),
		...
		u = function (n, o) {
			...
			if (
				(n.data('aimg') != t &&
					(('enabled' == n.data('aie8') && i.isIE(8)) || ('enabled' == n.data('amobile') && a)) &&
					n.html('<img class="tp-slider-alternative-image" src="' + n.data('aimg') + '">'),
			...
			if (
					...
					(s.params = new Array()),
						...
						(s.src =
							a.data('thumb') !== t
								...
								: n.attr('src')),
						a.data('title') !== t &&
							s.params.push({ from: RegExp('\\{\\{title\\}\\}', 'g'), to: a.data('title') }),
						a.data('description') !== t &&
							s.params.push({ from: RegExp('\\{\\{description\\}\\}', 'g'), to: a.data('description') });
					for (var r = 1; 10 >= r; r++)
						a.data('param' + r) !== t &&
							s.params.push({ from: RegExp('\\{\\{param' + r + '\\}\\}', 'g'), to: a.data('param' + r) });
						...
						var h =
							...
							f =
								'scroll_under' === u
									...
									: '[{"event":"click","action":"jumptoslide","slide":"' + u + '","delay":"0.2"}]';
				...
				(b = b === t ? 0 : b),
					...
					n
						...
						.append(
							'<div class="tp-fullwidth-forcer" style="width:100%;height:' + n.height() + 'px"></div>'
						),
			...
			if (
				...
				(T.addedyt = 0),
					...
					n.find('.tp-caption, .rs-background-video-layer').each(function (n) {
						...
						var d =
							r.data('noposteronmobile') ||
							r.data('noPosterOnMobile') ||
							r.data('posteronmobile') ||
							r.data('posterOnMobile') ||
							r.data('posterOnMObile');
						...
						g !== t && i.checkActions(r, o, g),
							...
							a &&
								((1 == s || 'true' == s) && (r.data('autoplayonlyfirsttime', 'false'), (s = !1)),
								(1 == l || 'true' == l || 'on' == l || '1sttime' == l) &&
									(r.data('autoplay', 'off'), (l = 'off'))),
							(1 == s || 'true' == s || '1sttime' == l) &&
								r.closest('li.tp-revslider-slidesli').addClass('rs-pause-timer-once'),
							(1 == l || 'true' == l || 'on' == l || 'no1sttime' == l) &&
								r.closest('li.tp-revslider-slidesli').addClass('rs-pause-timer-always');
					}),
					n.hover(
						function () {
					...
					o.li.each(function (t) {
						...
						('all' == o.lazyType ||
							('smart' == o.lazyType &&
								(0 == t || 1 == t || t == o.slideamount || t == o.slideamount - 1))) &&
							(L(i, o, t),
							S(i, o, function () {
								'carousel' == o.sliderType &&
									punchgs.TweenLite.to(i, 1, { autoAlpha: 1, ease: punchgs.Power3.easeInOut });
							}));
					});
				var z = j('#')[0];
				...
				(o.inviewport = !1),
					O != t &&
						...
						(O.visible_area = O.visible_area < 0.001 ? 100 * O.visible_area : O.visible_area),
						i.scrollTicker && i.scrollTicker(o, n)),
					setTimeout(function () {
						'carousel' == o.sliderType && i.prepareCarousel(o),
							!O.enable || (O.enable && o.inviewport) || (O.enable && !o.inviewport && 'wait' == !O.outof)
								? A(n, o)
								: (o.waitForFirstSlide = !0),
							i.manageNavigation && i.manageNavigation(o),
							o.slideamount > 1 &&
								(!O.enable || (O.enable && o.inviewport) ? P(n, o) : (o.waitForCountDown = !0)),
							setTimeout(function () {
						...
						: (0 != e('body').find(n) && f(o),
						  void (
								(n.outerWidth(!0) != o.width ||
									n.is(':hidden') ||
									('fullscreen' == o.sliderLayout && e(window).height() != o.lastwindowheight)) &&
		...
		g = function (a, n, o) {
			...
			e(window).width() < n.hideSliderAtLimit
				...
				: a.is(':hidden') &&
				  o &&
				  (r.data('olddisplay') != t && 'undefined' != r.data('olddisplay') && 'none' != r.data('olddisplay')
						? r.css({ display: r.data('olddisplay') })
						: r.css({ display: 'block' }),
		...
		y = function (n, o) {
			if (
				...
				'on' == o.autoHeight &&
					(o.ul.css({ overflow: 'hidden', width: '100%', height: '100%', maxHeight: 'none' }),
					n.css({ maxHeight: 'none' }),
					n.parent().css({ maxHeight: 'none' })),
				o.li.each(function (i) {
					var a = e(this),
						n = a.data('originalindex');
					((o.startWithSlide != t && n == o.startWithSlide) || (o.startWithSlide === t && 0 == i)) &&
			...
			n.parent().css({ overflow: 'visible' }),
				o.li.find('>img').each(function (i) {
					...
					r.addClass('defaultvid').css({ zIndex: 30 }),
						n.addClass('defaultimg'),
						'on' == o.panZoomDisableOnMobile && a && (n.data('kenburns', 'off'), n.data('bgfit', 'cover')),
					...
					n.closest('.slotholder').data(s),
						...
						'none' != o.dottedOverlay &&
							...
							n
								.closest('.slotholder')
								.append('<div class="tp-dottedoverlay ' + o.dottedOverlay + '"></div>');
					var l = n.attr('src');
					(s.src = l),
					...
					n.replaceWith(c),
						...
						n.data(s),
						n.attr('src', l),
						('standard' === o.sliderType || 'undefined' === o.sliderType) && n.css({ opacity: 0 });
				});
		},
		b = function (t, i, a, n) {
				...
				i.loadqueue &&
					e.each(i.loadqueue, function (e, i) {
						...
						(o = o.substring(0, o.length - 1) + n),
							(r += n),
							(w(r) === w(decodeURIComponent(t.src)) ||
								w(o) === w(decodeURIComponent(t.src)) ||
								w(d) === w(decodeURIComponent(t.src)) ||
								w(l) === w(decodeURIComponent(t.src)) ||
								w(s) === w(decodeURIComponent(t.src)) ||
								w(i.src) === w(decodeURIComponent(t.src)) ||
								w(i.src).replace(/^.*\/\/[^\/]+/, '') ===
									w(decodeURIComponent(t.src)).replace(/^.*\/\/[^\/]+/, '') ||
								('file://' === window.location.origin && w(t.src).match(new RegExp(n)))) &&
			...
			a.find('img,.defaultimg').each(function () {
				...
				if (
					...
					1 == n.youtubeapineeded &&
						...
						((r = !0), e.now() - n.youtubestarttime > 5e3 && 1 != n.youtubewarning))
				) {
					n.youtubewarning = !0;
		...
		A = function (t, a) {
			...
			return o.index() === n.index()
				...
				: (o.removeClass('next-revslide').addClass('processing-revslide'),
				  ...
				  (a.cd = 0),
				  'off' === a.spinner
						? t.find('.tp-loader').css({ display: 'none' })
		...
		z = function (e, a, n) {
			...
			if ('carousel' == e.sliderType)
				...
				e.ie &&
					...
					'on' == l.data('kenburns') &&
						(i.startKenBurn(l, e), h.add(punchgs.TweenLite.set(l, { autoAlpha: 0 }))),
					h.pause();
			}
			'off' != e.parallax.type &&
		...
		H = function (n, o, r, s, l, d, c) {
			'carousel' === o.sliderType ||
				...
				'on' == r.data('kenburns') &&
					(r.data('kbtl') != t ? (r.data('kbtl').timeScale(1), r.data('kbtl').play()) : i.startKenBurn(r, o)),
				...
				d.find('.rs-background-video-layer').each(function (t) {
					...
					i.stopVideo && (i.resetVideo(n, o), i.stopVideo(n, o)),
						punchgs.TweenLite.to(n, 1, { autoAlpha: 0, ease: punchgs.Power3.easeInOut, delay: 0.2 });
				});
			var u = {};
		...
		P = function (n, o) {
			(o.cd = 0),
				...
				o.stopAfterLoops != t && o.stopAfterLoops > -1
					? (o.looptogo = o.stopAfterLoops)
					: (o.looptogo = 9999999),
				o.stopAtSlide != t && o.stopAtSlide > -1
					? (o.lastslidetoshow = o.stopAtSlide)
					: (o.lastslidetoshow = 999),
				(o.stopLoop = 'off'),
				...
				n.on('starttimer', function () {
					1 != o.conthover &&
						...
						(1 === o.noloopanymore ||
							...
							(r.css({ visibility: 'visible' }), r.data('tween').resume(), (o.sliderstatus = 'playing'))),
			...
			var s = function () {
				0 == e('body').find(n).length && (O(n, o), clearInterval(o.cdint)),
					...
					1 == n.data('conthover-changed') &&
						((o.conthover = n.data('conthover')), n.data('conthover-changed', 0)),
			...
			r.data(
				...
				punchgs.TweenLite.fromTo(
					...
					o.delay / 1e3,
					{ width: '0%' },
					{ force3D: 'auto', width: '100%', ease: punchgs.Linear.easeNone, onComplete: s, delay: 1 }
				)
			),
				r.data('opt', o),
				...
				n.on('tp-mouseleft', function () {
					(o.mouseoncontainer = !1),
						1 != n.data('conthover') &&
							'on' == o.navigation.onHoverStop &&
							((1 == o.viewPort.enable && o.inviewport) || 0 == o.viewPort.enable) &&
		...
		j = function (e) {
			for (
				var t, i = [], a = window.location.href.slice(window.location.href.indexOf(e) + 1).split('_'), n = 0;
				n < a.length;
				n++
			)
