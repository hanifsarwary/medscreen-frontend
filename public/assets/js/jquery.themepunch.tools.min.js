	...
	if (!i.TweenLite) {
		...
		var I = v(
				...
				function (e, i, s) {
					...
					if (
						((this._overwrite = l =
							null == l ? $[I.defaultOverwrite] : 'number' == typeof l ? l >> 0 : $[l]),
					...
					'number' !== u &&
						...
						'string' == typeof _ && (a || isNaN(_))
							? ((c.fp = a),
							  ...
							  (c = { t: l, p: 'setRatio', s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0 }))
		...
		var W = function (t, e, i) {
				var s,
					...
					n = t._gsTweenID;
				if (
					(q[n || (t._gsTweenID = n = 't' + B++)] || (q[n] = { target: t, tweens: [] }),
					...
					(o = r[n]) === e ||
						...
						(o._timeline !== e._timeline
							...
							: u >= o._startTime &&
							  ...
							  (((m || !o._initted) && 2e-10 >= u - o._startTime) || (f[c++] = o)));
				for (n = c; --n > -1; )
		...
		(n._init = function () {
			...
			(n._initProps = function (e, i, s, r) {
				...
				F[e._gsTweenID] && V(),
					this.vars.css ||
						(e.style && e !== t && e.nodeType && Q.css && this.vars.autoCSS !== !1 && O(this.vars, e));
				for (n in this.vars)
				...
				return r && this._kill(r, e)
					...
					: this._overwrite > 1 && this._firstPT && s.length > 1 && Y(e, this, i, this._overwrite, s)
			...
			var u,
				...
				W = (function () {
					...
					return (
						...
						(/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(Y) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(Y)) &&
					...
					if ((_ && (r = -r), '%' === s && -1 !== i.indexOf('border')))
						...
						f.appendChild(B),
							...
							u &&
								'%' === s &&
								a.cacheWidths !== !1 &&
								((l = f._gsCache = f._gsCache || {}), (l.time = h), (l.width = 100 * (o / r))),
							0 !== o || n || (o = Z(t, i, r, s, !0));
					}
					return _ ? -o : o;
				}),
				...
				ue = function (t, e) {
					...
					for (i = 0; n.length > i; i++)
						(r = n[i]),
							...
							(o +=
								s +
								(e ? 'hsla(' + r[0] + ',' + r[1] + '%,' + r[2] + '%,' + r[3] : 'rgba(' + r.join(',')) +
								')');
					return o;
				},
					...
					((E._parseToProxy = function (t, e, i, r, s, n) {
						...
						for (
							i._transform = null,
								...
								r = u = i.parse(t, e, r, s),
								F = d,
								n && ((i._transform = p), f && ((f._prev = null), f._prev && (f._prev._next = null)));
							r && r !== f;
							...
							? (a.l++,
							  ...
							  o > 0
									? ((a.data['xn' + o] = e + i),
									  ...
									  (a['xn' + o] = e),
									  a.plugin ||
											((a.xfirst = new de(a, 'xn' + o, e, i, a.xfirst || a, 0, a.n, s, a.pr)),
											(a.xfirst.xs0 = 0)),
									  a)
						...
						for (h = l.length > o.length ? l.length : o.length, a = 0; h > a; a++)
							(e = o[a] = o[a] || this.dflt),
								...
								c &&
									...
									(f = i.indexOf(c)),
									u !== f &&
										(-1 === f ? (o[a] = o[a].split(c).join('')) : -1 === u && (o[a] += ' ' + c)));
						(e = o.join(', ')), (i = l.join(', '));
					}
			...
			var we,
				...
				Le = function (t, e, i, r, s) {
					...
					x && ((v = x.xOrigin), (y = x.yOrigin)),
						(!r || 2 > (n = r.split(' ')).length) &&
							...
							(e = re(e).split(' ')),
							(n = [
								(-1 !== e[0].indexOf('%') ? (parseFloat(e[0]) / 100) * c.width : parseFloat(e[0])) +
									c.x,
								(-1 !== e[1].indexOf('%') ? (parseFloat(e[1]) / 100) * c.height : parseFloat(e[1])) +
									c.y,
							])),
				...
				Xe = function (t, e) {
					...
					if (
						...
						(o.svg || (t.getBBox && Ne(t))) &&
							(i && -1 !== (t.style[Pe] + '').indexOf('matrix') && ((r = t.style[Pe]), (i = 0)),
							...
							i &&
								...
								(-1 !== s.indexOf('matrix')
									...
									: -1 !== s.indexOf('translate') &&
									  ((r = 'matrix(1,0,0,1,' + s.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(',') + ')'),
									  (i = 0)))),
						i)
					)
						return Fe;
				...
				ze = (E.getTransform = function (t, i, r, n) {
					...
					if (
						...
						_.svg &&
							(Le(t, Q(t, Oe, s, !1, '50% 50%') + '', _, t.getAttribute('data-svg-origin')),
						...
						if (16 === o.length) {
							...
							(_.x = o[4] || 0),
								...
								Math.abs(c) > 90 &&
									270 > Math.abs(c) &&
									(p
										? ((h *= -1), (c += 0 >= f ? 180 : -180), (f += 0 >= f ? 180 : -180))
										: ((u *= -1), (c += 0 >= c ? 180 : -180))),
								(_.scaleX = h),
								(_.scaleY = u),
								(_.rotation = f),
				...
				Be = function (t) {
					...
					if (c) {
						...
						if (
							...
							(f.filter =
								-1 !== e.indexOf('DXImageTransform.Microsoft.Matrix(') ? e.replace(M, y) : y + ' ' + e),
							(0 === t || 1 === t) &&
								1 === o &&
								0 === l &&
								0 === h &&
							...
							C || S.skewX || z
								? ((C *= L),
								  ...
								  b &&
										...
										S.skewY && ((e *= v), (s *= v))),
								  z &&
										((N += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset),
					...
					(h = 1),
						...
						(x =
							S.xPercent || S.yPercent
								...
								: 'matrix3d('),
						(x +=
							(d > e && e > -d ? w : e) + T + (d > s && s > -d ? w : s) + T + (d > o && o > -d ? w : o)),
						(x +=
							T +
							(d > u && u > -d ? w : u) +
							T +
				...
				xe('borderRadius', {
					...
					parser: function (t, e, i, n, a) {
						...
						var o,
							...
							P = t.style;
						for (
							d = parseFloat(t.offsetWidth), m = parseFloat(t.offsetHeight), o = e.split(' '), l = 0;
							b.length > l;
							l++
						)
							this.p.indexOf('border') && (b[l] = q(b[l])),
								...
								g !== v &&
									...
									'%' === g
										? ((f = 100 * (x / d) + '%'), (u = 100 * (T / m) + '%'))
										: 'em' === g
										? ((w = Z(t, 'borderLeft', 1, 'em')), (f = x / w + 'em'), (u = T / w + 'em'))
										: ((f = x + 'px'), (u = T + 'px')),
									y && ((c = parseFloat(f) + p + g), (h = parseFloat(u) + p + g))),
					...
					parser: function (t, e, i, r, n, a) {
						var o,
							...
							m = this.format(
								(p
									? d
										? p.getPropertyValue(_ + '-x') + ' ' + p.getPropertyValue(_ + '-y')
										: p.getPropertyValue(_)
									: t.currentStyle.backgroundPositionX + ' ' + t.currentStyle.backgroundPositionY) ||
									'0 0'
							),
							g = this.format(e);
						if (
			...
			(h = a.prototype),
				...
				(h._onInitTween = function (t, e, o) {
					...
					if (
						(f &&
							'' === b.zIndex &&
							((h = Q(t, 'zIndex', s)), ('auto' === h || '' === h) && this._addLazySet(b, 'zIndex', 0)),
						'string' == typeof e &&
							((m = b.cssText),
							(h = K(t, s)),
							(b.cssText = m + ';' + e),
										...
										? ((h = parseFloat(c)),
										  ...
										  g
												? ((f = parseInt(_.charAt(0) + '1', 10)),
												  ...
												  (f *= parseFloat(_)),
												  (d = _.replace(x, '')))
												: ((f = parseFloat(_)), (d = m ? _.replace(x, '') : '')),
										  '' === d && (d = a in r ? r[a] : p),
										  ...
										  (!h && 0 !== h) || (!f && 0 !== f)
												? void 0 !== v[a] && (_ || ('NaN' != _ + '' && null != _))
													? ((i = new de(v, a, f || h || 0, 0, i, -1, a, !1, 0, c, _)),
													  (i.xs0 =
															'none' !== _ ||
								...
								if (
									...
									if (1 === s.type)
										if (((r = s.l), 2 === r)) s.t[s.p] = s.xs0 + e + s.xs1 + s.xn1 + s.xs2;
											...
											s.t[s.p] =
												s.xs0 + e + s.xs1 + s.xn1 + s.xs2 + s.xn2 + s.xs3 + s.xn3 + s.xs4;
										else if (5 === r)
											s.t[s.p] =
												s.xs0 +
												e +
				...
				(h._enableTransforms = function (t) {
					(this._transform = this._transform || ze(this._target, s, !0)),
						(this._transformType =
							(this._transform.svg && we) || (!t && 3 !== this._transformType) ? 2 : 3);
				});
			var je = function () {
	...
	var e = t.GreenSockGlobals || t,
		...
		y = function (t, e, i, s, o) {
			...
			var h,
				...
				te = [];
			for (
				W && (Z = Z.split('++').join('')), H && (R = R.split('<').join('{{LT}}')), h = R.length, p = G(), d = 0;
				h > d;
				d++
			)
			...
			if (A || L)
				for (d = 0; h > d; d++)
					(b = w[d]),
						...
						(f || L || (M && !D)) &&
							((x = b.offsetTop),
							A && f && x !== z && 'BR' !== b.nodeName && ((_ = []), A.push(_), (z = x)),
				...
				for (C = !L || (!D && !M), d = 0; A.length > d; d++) {
					for (
						_ = A[d],
							P = n.createElement('div'),
							P.style.cssText =
								'display:block;text-align:' + U + ';position:' + (L ? 'absolute;' : 'relative;'),
						...
						'BR' !== _[y].nodeName &&
							...
							L &&
								(0 === y && ((P.style.top = b._y + 'px'), (P.style.left = E + x + 'px')),
								(b.style.top = '0px'),
			...
			L &&
				(Y > t.clientHeight &&
					((t.style.height = Y - B + 'px'), Y > t.clientHeight && (t.style.height = Y + N + 'px')),
				q > t.clientWidth &&
					((t.style.width = q - j + 'px'), q > t.clientWidth && (t.style.width = q + X + 'px'))),
				v(i, K),
				v(s, J),
				v(o, te);
		},
