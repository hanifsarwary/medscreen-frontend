	...
	var checkActions_intern = function (e, t, a) {
				...
				jQuery.each(a, function (a, o) {
					...
					switch (o.action) {
						...
						case 'togglefullscreen':
							void 0 == t.fullscreentoggledby && (t.fullscreentoggledby = new Array()),
					...
					switch (
						(e.on(o.event, function () {
							var a =
								'backgroundvideo' == o.layer
									? jQuery('.active-revslide .slotholder .rs-background-video-layer')
									: 'firstvideo' == o.layer
							...
							if ('stoplayer' == o.action || 'togglelayer' == o.action || 'startlayer' == o.action) {
								if (a.length > 0)
									if (
										'startlayer' == o.action ||
										('togglelayer' == o.action && 'in' != a.data('animdirection'))
									) {
										...
										void 0 != l && l.pause(0).kill(),
											_R.animateSingleCaption && _R.animateSingleCaption(a, t, r, i, 0, !1, !0);
										...
										('stoplayer' == o.action ||
											('togglelayer' == o.action && 'out' != a.data('animdirection'))) &&
											...
											_R.unToggleState(a.data('layertoggledby')));
							} else
								!_ISM ||
								('playvideo' != o.action &&
									'stopvideo' != o.action &&
									'togglevideo' != o.action &&
									'mutevideo' != o.action &&
									'unmutevideo' != o.action &&
									'toggle_mute_video' != o.action)
									? punchgs.TweenLite.delayedCall(
											o.delay,
											function () {
		...
		actionSwitches = function (tnc, opt, a, _nc) {
			switch (a.action) {
				...
				case 'toggleslider':
					(opt.noloopanymore = 0),
						'playing' == opt.sliderstatus
							...
							: (opt.c.revresume(), _R.toggleState(opt.slidertoggledby));
					break;
				case 'pauseslider':
					opt.c.revpause(), _R.unToggleState(opt.slidertoggledby);
					break;
				...
				case 'togglevideo':
					tnc.length > 0 &&
						(_R.isVideoPlaying(tnc, opt) ? _R.stopVideo && _R.stopVideo(tnc, opt) : _R.playVideo(tnc, opt));
					break;
				case 'mutevideo':
				...
				case 'toggle_mute_video':
					tnc.length > 0 &&
						(_R.isVideoMuted(tnc, opt) ? _R.unMuteVideo(tnc, opt) : _R.muteVideo && _R.muteVideo(tnc, opt)),
				...
				case 'toggleclass':
					tnc.length > 0 &&
						(tnc.hasClass(a.classname) ? tnc.removeClass(a.classname) : tnc.addClass(a.classname));
					break;
				case 'gofullscreen':
				case 'exitfullscreen':
				case 'togglefullscreen':
