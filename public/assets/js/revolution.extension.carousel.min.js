		...
		carouselToEvalPosition: function (i, t) {
			...
			var o =
					'center' === l.horizontal_align
						? (l.wrapwidth / 2 - l.slide_width / 2 - l.slide_globaloffset) / l.slide_width
			...
			(d =
				(n >= 0.3 && 'left' === t) || (n >= 0.7 && 'right' === t)
					...
					? h
					: d),
				(d = 'off' === l.infinity ? (0 > r ? r : o > i.slideamount - 1 ? o - (i.slideamount - 1) : d) : d),
				(l.slide_offset_target = d * l.slide_width),
				0 !== Math.abs(l.slide_offset_target) ? s(i, t, !0) : e.organiseCarousel(i, t);
		},
				...
				'on' === s.infinity &&
					((d =
						d > s.wrapwidth - s.inneroffset && 'right' == i
							...
							: d),
					(d = d < 0 - s.inneroffset - s.slide_width && 'left' == i ? d + s.maxwidth : d)),
					(l[n] = d);
			}
			var f = 999;
			s.slides &&
				jQuery.each(s.slides, function (a, r) {
					var n = l[a];
					'on' === s.infinity &&
						((n = n > s.wrapwidth - s.inneroffset && 'left' === i ? l[0] - (o - a) * s.slide_width : n),
						(n =
					...
					var h =
							'center' === s.horizontal_align
								? (Math.abs(s.wrapwidth / 2) - (d.left + s.slide_width / 2)) / s.slide_width
								: (s.inneroffset - d.left) / s.slide_width,
						w = 'center' === s.horizontal_align ? 2 : 1;
					if (
						(((t && Math.abs(h) < f) || 0 === h) && ((f = Math.abs(h)), (s.focused = a)),
						...
						if ('on' === s.vary_fade)
							d.autoAlpha = 1 - Math.abs((1 / Math.ceil(s.maxVisibleItems / w)) * h);
						else
					...
					void 0 !== s.maxRotation &&
						...
						('on' === s.vary_rotation
							? ((d.rotationY =
									...
									Math.abs(
										(1 - Math.abs((1 / Math.ceil(s.maxVisibleItems / w)) * h)) * s.maxRotation
									)),
							  (d.autoAlpha = Math.abs(d.rotationY) > 90 ? 0 : d.autoAlpha))
							: (d.rotationY = h >= 1 || -1 >= h ? s.maxRotation : Math.abs(h) * s.maxRotation),
						...
						(d.transformStyle =
							'3D' != e.parallax.type && '3d' != e.parallax.type ? 'flat' : 'preserve-3d'),
	...
	var i = function (e) {
			...
			(i.infbackup = i.infinity),
				...
				void 0 !== i.border_radius &&
					...
					punchgs.TweenLite.set(e.c.find('.tp-revslider-slidesli'), { borderRadius: i.border_radius });
		},
		t = function (t) {
			...
			void 0 === a.wrap && i(t),
				...
				(a.wrapoffset = 'center' === a.horizontal_align ? (t.c.width() - l - s - a.wrapwidth) / 2 : 0),
					...
					onComplete: function () {
						(l.slide_globaloffset =
							'off' === l.infinity
								...
								: e.simp(l.slide_globaloffset + l.slide_offset_target, l.maxwidth)),
							(l.slide_offset = e.simp(l.slide_offset, l.maxwidth)),
		...
		r = function (i) {
			var t = 0,
				a = i.carousel;
			if ((void 0 !== a.positionanim && a.positionanim.kill(), 'none' == a.slide_globaloffset))
				a.slide_globaloffset = t = 'center' === a.horizontal_align ? a.wrapwidth / 2 - a.slide_width / 2 : 0;
			else {
				(a.slide_globaloffset = a.slide_offset), (a.slide_offset = 0);
				var s = i.c.find('.processing-revslide').index(),
					l =
						'center' === a.horizontal_align
							? (a.wrapwidth / 2 - a.slide_width / 2 - a.slide_globaloffset) / a.slide_width
