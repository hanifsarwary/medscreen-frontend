...
!(function (a) {
	...
	jQuery.extend(!0, t, {
			...
			void 0 != i &&
				...
				(1 == n || 'true' == n || 'on' == n || '1sttime' == n || o
					? (t.playVideo(a, e),
					  ...
					  (o || '1sttime' == n) && (a.data('autoplayonlyfirsttime', !1), a.data('autoplay', 'off')))
		...
		animateSingleCaption: function (a, n, r, u, w, y, b) {
			...
			if (
				(a.data('_pw') || (a.data('_pw', L), a.data('_lw', W), a.data('_mw', C)),
				'fullscreen' == n.sliderLayout && (u = _ / 2 - (n.gridheight[n.curWinRange] * n.bh) / 2),
				('on' == n.autoHeight || (void 0 != n.minHeight && n.minHeight > 0)) &&
					(u = n.conh / 2 - (n.gridheight[n.curWinRange] * n.bh) / 2),
				0 > u && (u = 0),
				n.debugMode)
			) {
				a.closest('li')
			...
			if (
				('off' == Q ||
				(k < n.hideCaptionAtLimit && 'on' == a.data('captionhidden')) ||
				k < n.hideAllCaptionAtLimit
				...
				a.data('layertype', 'image'),
					0 == M.width() && M.css({ width: 'auto' }),
					0 == M.height() && M.css({ height: 'auto' }),
					void 0 == M.data('ww') && M.width() > 0 && M.data('ww', M.width()),
					void 0 == M.data('hh') && M.height() > 0 && M.data('hh', M.height());
				var O = M.data('ww'),
					H = M.data('hh'),
				...
				void 0 == O && (O = 0),
					void 0 == H && (H = 0),
					'off' !== j
						? ('grid' != R && F ? M.width(O) : M.width(O * n.bw),
						  'grid' != R && D ? M.height(H) : M.height(H * n.bh))
						: (M.width(O), M.height(H));
			}
			if (
				('slide' === R && ((r = 0), (u = 0)),
				a.hasClass('tp-videolayer') || a.find('iframe').length > 0 || a.find('video').length > 0)
			) {
				...
				M.css({ display: 'block' }),
					void 0 == a.data('videowidth') &&
						(a.data('videowidth', M.width()), a.data('videoheight', M.height()));
				var Z,
				...
				(O = parseFloat(O)),
					(H = parseFloat(H)),
					void 0 === a.data('cssobj') && ((Z = g(a, 0)), a.data('cssobj', Z));
				...
				((0 == V && !N) || (1 != a.data('forcecover') && !a.hasClass('fullscreenvideo') && !N)) &&
					(M.width(O * n.bw), M.height(H * n.bh));
			}
			...
			e(a, '.frontcorner', 'left', 'borderRight', 'borderTopColor', U, q),
				e(a, '.frontcornertop', 'left', 'borderRight', 'borderBottomColor', U, q),
				e(a, '.backcorner', 'right', 'borderLeft', 'borderBottomColor', U, q),
				e(a, '.backcornertop', 'right', 'borderLeft', 'borderTopColor', U, q),
				'on' == n.fullScreenAlignForce && ((r = 0), (u = 0));
			var E = a.data('arrobj');
			if (void 0 === E) {
				var E = new Object();
				(E.voa = p(a.data('voffset'), n)[n.curWinRange] || p(a.data('voffset'), n)[0]),
					(E.hoa = p(a.data('hoffset'), n)[n.curWinRange] || p(a.data('hoffset'), n)[0]),
					(E.elx = p(a.data('x'), n)[n.curWinRange] || p(a.data('x'), n)[0]),
					(E.ely = p(a.data('y'), n)[n.curWinRange] || p(a.data('y'), n)[0]);
			}
			...
			'on' == n.fullScreenAlignForce && ((ra = n.ulw), (da = n.ulh)),
				(aa =
					'center' === aa || 'middle' === aa
						? ra / 2 - ta / 2 + oa
						: 'left' === aa
			...
			var sa = a.data('lasttriggerstate'),
				...
				ua = a.css('z-Index');
			b ||
				('reset' == sa && 'bytrigger' != pa
					? (a.data('triggerstate', 'on'), a.data('animdirection', 'in'), (la = 'on'))
					: 'reset' == sa &&
					  'bytrigger' == pa &&
					  (a.data('triggerstate', 'off'), a.data('animdirection', 'out'), (la = 'off'))),
			...
			if (
				((fa = jQuery.isNumeric(fa) ? fa : 0), wa.pause(), (1 > fa && 1 != a.data('outstarted')) || 2 == T || b)
			) {
				var ya = a;
				if (
					(void 0 != a.data('mySplitText') && a.data('mySplitText').revert(),
					(void 0 != a.data('splitin') && a.data('splitin').match(/chars|words|lines/g)) ||
						(void 0 != a.data('splitout') && a.data('splitout').match(/chars|words|lines/g)))
				) {
					var ba = a.find('a').length > 0 ? a.find('a') : a;
					a.data(
						'mySplitText',
						new punchgs.SplitText(ba, {
				...
				void 0 !== a.data('mySplitText') &&
					...
					(ya = a.data('mySplitText')[a.data('splitin')]);
				var xa = new Object(),
				...
				if (!a.data('$anims') || b || Ta) {
					...
					(Wa = s(Wa, a.data('transform_idle'))),
						...
						ja &&
							((Ca = s(Ca, a.data('transform_hover'))),
							(Ca = c(Ca, a.data('style_hover'))),
							a.data('hover', Ca)),
				...
				if (
					((xa.f.anim.x = xa.f.anim.x * n.bw || d(xa.f.anim.x, n, ta, ia, ma, ga, 'horizontal')),
					(xa.f.anim.y = xa.f.anim.y * n.bw || d(xa.f.anim.y, n, ta, ia, ma, ga, 'vertical')),
					2 != T || b)
				) {
					if (ya != a) {
					...
					if (
						...
						Ra.eventCallback('onStart', function () {
							...
							(e.layer = a),
								...
								n.c.trigger('revolution.layeraction', e);
						}),
						...
						var _a = new Object();
						(_a.ease = xa.r.anim.ease),
							(_a.overflow = Ia.anim.overflow = 'hidden'),
							(_a.x = _a.y = 0),
							(Ia.anim.x = Ia.anim.x * n.bw || d(Ia.anim.x, n, ta, ia, ma, ga, 'horizontal')),
							(Ia.anim.y = Ia.anim.y * n.bw || d(Ia.anim.y, n, ta, ia, ma, ga, 'vertical')),
							wa.add(punchgs.TweenLite.fromTo(C, xa.f.speed, Ia.anim, _a, La.elemdelay), ca);
				...
				a.data('timeline', wa),
					...
					(0 !== fa && 2 != T) ||
						...
						(void 0 == ha || (-1 != T && 2 != T) || 'bytriger' === ha
							? punchgs.TweenLite.delayedCall(999999, t.endMoveCaption, [a, C, L, n], n.sliderscrope)
							: punchgs.TweenLite.delayedCall(
									parseInt(a.data('end'), 0) / 1e3,
									t.endMoveCaption,
									[a, C, L, n],
									n.sliderscrope
							  )),
					...
					('sliderenter' != pa || ('sliderenter' == pa && n.overcontainer)) &&
						(-1 == T || 1 == T || b || (0 == T && 1 > fa && a.hasClass('rev-static-visbile'))) &&
						((1 > fa && fa > 0) ||
							(0 == fa && 'bytrigger' != pa && 'keep' != sa) ||
							(0 == fa && 'bytrigger' != pa && 'keep' == sa && 'on' == la) ||
							('bytrigger' == pa && 'keep' == sa && 'on' == la)) &&
						(wa.resume(va), t.toggleState(a.data('layertoggledby')));
			}
			'on' == a.data('loopanimation') && punchgs.TweenLite.set(W, { minWidth: ta, minHeight: ia }),
				0 == a.data('slidelink') || (1 != a.data('slidelink') && !a.hasClass('slidelink'))
					? (punchgs.TweenLite.set(C, { width: 'auto', height: 'auto' }), a.data('slidelink', 0))
					: (punchgs.TweenLite.set(C, { width: '100%', height: '100%' }), a.data('slidelink', 1));
		},
			...
			(g.anim.x = g.anim.x * o.bw || d(g.anim.x, o, v, f, w.top, w.left, 'horizontal')),
				...
				y
					? ((y.anim.ease = g.anim.ease),
					  ...
					  (y.anim.x = y.anim.x * o.bw || d(y.anim.x, o, v, f, w.top, w.left, 'horizontal')),
					  (y.anim.y = y.anim.y * o.bw || d(y.anim.y, o, v, f, w.top, w.left, 'vertical')),
	...
	var i = function () {
		...
		g = function (a, e) {
			...
			if (
				('rekursive' == e &&
					((t = a.closest('.tp-caption')), t && a.css('fontSize') === t.css('fontSize') && (n = !0)),
				...
				(i.paddingTop =
					void 0 === a.data('paddingtop') ? parseInt(a.css('paddingTop'), 0) || 0 : a.data('paddingtop')),
				(i.paddingBottom =
					void 0 === a.data('paddingbottom')
						? parseInt(a.css('paddingBottom'), 0) || 0
						: a.data('paddingbottom')),
				(i.paddingLeft =
					void 0 === a.data('paddingleft') ? parseInt(a.css('paddingLeft'), 0) || 0 : a.data('paddingleft')),
				(i.paddingRight =
					void 0 === a.data('paddingright')
						? parseInt(a.css('paddingRight'), 0) || 0
						: a.data('paddingright')),
				(i.marginTop =
					void 0 === a.data('margintop') ? parseInt(a.css('marginTop'), 0) || 0 : a.data('margintop')),
				(i.marginBottom =
					void 0 === a.data('marginbottom')
						? parseInt(a.css('marginBottom'), 0) || 0
						: a.data('marginbottom')),
				(i.marginLeft =
					void 0 === a.data('marginleft') ? parseInt(a.css('marginLeft'), 0) || 0 : a.data('marginleft')),
				(i.marginRight =
					void 0 === a.data('marginright') ? parseInt(a.css('marginRight'), 0) || 0 : a.data('marginright')),
				(i.borderTopWidth =
				...
				if (
					...
					(i.minHeight =
						void 0 === a.data('height') ? parseInt(a.css('minHeight'), 0) || 0 : a.data('height')),
				...
				(i.maxWidth = void 0 === a.data('width') ? parseInt(a.css('maxWidth'), 0) || 'none' : a.data('width')),
					(i.maxHeight =
						void 0 === a.data('height') ? parseInt(a.css('maxHeight'), 0) || 'none' : a.data('height')),
					(i.wan =
						void 0 === a.data('wan') ? parseInt(a.css('-webkit-transition'), 0) || 'none' : a.data('wan')),
					(i.moan =
						void 0 === a.data('moan')
		...
		f = function (a, e) {
			...
			if (a.hasClass('rs-slideloop') && void 0 == a.data('loop-timeline')) {
				...
				(d *= e),
					...
					a
						.data('loop-timeline')
						.append(
							new punchgs.TweenLite.fromTo(a, n, { force3D: 'auto', x: d, y: s }, { x: l, y: p, ease: r })
						),
					a.data('loop-timeline').append(
						new punchgs.TweenLite.fromTo(
							a,
			...
			if (a.hasClass('rs-pulse') && void 0 == a.data('loop-timeline')) {
				...
				a
					.data('loop-timeline')
					.append(new punchgs.TweenLite.fromTo(a, n, { force3D: 'auto', scale: h }, { scale: c, ease: r })),
					a.data('loop-timeline').append(
						new punchgs.TweenLite.fromTo(
							a,
							n,
