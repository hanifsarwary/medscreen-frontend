	...
	var e = function (e, o, a, i) {
					...
					for (var x = 0, y = 0, T = 0; T < o.slots; T++) {
						...
						for (var z = 0; z < o.slots; z++)
							n.append(
								...
								void 0 != s &&
									void 0 != l &&
									punchgs.TweenLite.set(n.find('.slot').last(), { rotationZ: l });
						x += o.slotw;
					}
					break;
				case 'vertical':
		...
		o = function (t, e, o, a, i) {
			...
			(e.duringslidechange = !0),
				...
				jQuery.each(
					['parallaxcircles', 'slidingoverlay', 'slide', 'slideover', 'slideremove', 'parallax'],
					function (t, e) {
				...
				'random' == o &&
					((o = Math.round(Math.random() * y.length - 1)), o > y.length - 1 && (o = y.length - 1)),
				'random-static' == o &&
		...
		i = function (t, i, n, r, s, l, d, h, f) {
				...
				t.find('.slot-circle-wrapper').each(function (t) {
					if (r > t) {
						...
						f.add(punchgs.TweenLite.fromTo(a, b, m, x), D),
							...
							f.add(punchgs.TweenLite.fromTo(a, 0.001, { autoAlpha: 0 }, { autoAlpha: 1 }), 0);
					}
				});
			}
			var p = l.index(),
			...
			if (
				((T = 'default' === T ? v[9] || punchgs.Power2.easeInOut : T || v[9] || punchgs.Power2.easeInOut),
				...
				switch (m) {
					...
					case 4:
						f.add(punchgs.TweenLite.set(h.parent(), { backgroundColor: E, force3D: 'auto' }), 0),
							f.add(
								punchgs.TweenLite.set(d.parent(), { backgroundColor: 'transparent', force3D: 'auto' }),
								0
							),
			...
			if (12 == t || 13 == t || 14 == t || 15 == t) {
				...
				('fullwidth' == r.sliderLayout || 'fullscreen' == r.sliderLayout) &&
					...
					(4 == m || 5 == m) && (te = 0.6),
					6 == m && (te = 1.4),
					(5 == m || 6 == m) && ((ee = 1.4), ($ = 0), (F = 0), (G = 0), (U = 0), (W = 0)),
					6 == m && (ee = 0.6);
				7 == m && ((F = 0), (G = 0));
			...
			if (16 == t) {
				...
				'on' == r.autoHeight && (G = n.height()),
					l
						...
						.wrap('<div class="tp-papercut" style="width:' + F + 'px;height:' + G + 'px;"></div>'),
					l
				...
				f.add(punchgs.TweenLite.set(l.find('.tp-half-one'), { overflow: 'hidden' }), 0),
					f.add(
						punchgs.TweenLite.fromTo(
							...
							{ scale: fe, rotation: re, y: 0 - G - G / 4, autoAlpha: 0, ease: T }
						),
						0
					),
					f.add(
