$(document).ready(function () {
	...
	if ($('#instafeed-widget').length > 0) {
		$('#instafeed-widget').instastory({
			...
			limit: 6,
			template:
				'<div class="item col-xs-4 col-sm-6 col-md-4"><figure><a href="{{link}}" target="_blank"><div class="overlay icon"><div class="info"><span class="icon-more"></span></div></div><img src="{{image}}" /></a></figure></div>',
		});
	}
	/*-----------------------------------------------------------------------------------*/
	/*	FITVIDS VIDEO
