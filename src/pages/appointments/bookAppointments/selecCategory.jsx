        ...
        return (
            <div class="col-sm-12">
                <div class="form-field forms-field appointment-form-margin">
                    <label> <b> {this.props.tests.panel_name}</b>
                    {
                      this.props.tests.price_type === "RANGE" ?
                      <span class="info-icon">
                          <span class="ico-info">
                            <svg width="30px" height="18px" viewBox="0 0 16 16" class="bi bi-info-circle tm4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
